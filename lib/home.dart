      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: SvgPicture.asset('assets/menu.svg',
              width: 14, height: 14, color: AppColors.black),
        ),
        title: Padding(
          padding: const EdgeInsets.only(left: 10),
          child: Image.asset('assets/sd.png', width: 120),
        ),
      ),
      body: ListView(
        children: [
          ...
          Padding(
            padding: standardPaddingX,
            child: PrimaryText(
                text: 'Discover', fontWeight: FontWeight.w700, size: 16),
          ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => ProductDetail(image)));
      },
      child: Hero(
        tag: image,
        child: Container(
